---
title: Convert Word Documents in Cloud via C#
description: Convert Word Documents in C# with Cloud API. Convert PDF to Word, DOCX to EPUB, HTML to DOCX 
weight: 10
url: /net/convert
---
...
<div class="container">
<div class="row">
<h1>Convert Word Documents in C#</h1>
</div>
</div>
</div>
<div class="wmh">
...
<div class="container">
<div class="row">
<p class="navbar-text"><a href="/words/family/">Words Cloud</a> / <a id="sdk" href="/words/net/"> .NET</a> / Convert</p>
</div>
</div>
</div>
<div class="wgray">
<div class="container">
<div class="row">
<div class="w"><p>Convert Word documents in C# with a high-performance format conversion <a target="_blank" href="https://apireference.aspose.cloud/words/#/Convert">REST API</a>. Create, combine, integrate document conversions of any type and scale into your systems to create workflows specific to your business tasks.</p>
<p>Aspose document conversion platform provides maximum performance and allows converting Word, OpenOffice, PDF, HTML, Markdown, E-Mail, Postscript, plain text and other documents in any direction with top quality and high speed. With .NET SDK you have 24/7 access to a full range of Document Automation and Conversion features, required by C# developers to implement their document-processing solutions.</p>
...
<h2>Convert Word Documents using C# library</h2>
<p>Aspose Cloud provides a powerful document conversion C# library, designed to convert Word documents in C# to and from Word-based formats, and also supports documents in various OpenOffice formats, E-Mail formats, PDF, HTML, Markdown, Postscript, XAML and plain text.</p>
<h2>Convert PDF to Word in C#</h2>
...
<p>You can easily convert <b>PDF to DOC</b> with our C# library. Aspose Cloud API allows converting PDF to various Word-based document formats, including DOCX, RTF and ODT.</p>
...
<h2>Convert Word to PDF in C#</h2>
...
<p>You can easily convert Word to PDF with C# library. The output document will conform to the "PDF 1.5" or "PDF/A-1b" specification.</p>
...
<p>With .NET SDK you can easily convert MOBI to EPUB format. EPUB has greater support across all platforms, whereas MOBI is mainly an Amazon Kindle e-reader format.</p>
...
<p>PDF is also widely accepted as an eBook format. With .NET SDK you can convert eBook from MOBI format to more versatile PDF with ease.</p>
...
<h2>Convert Word to EPUB in C#</h2>
<p>With .NET SDK you can convert <b>DOCX to EPUB</b>, which is a widespread electronic book format. The original document content, formatting, images, hyperlinks and navigation would be fully compatible and operational in any electronic book reader.<p>
<h2>Convert Word to Image in C#</h2>
<p>There is no built-in option in Microsoft Office to save a Word document as a set of images. Using Aspose C# library you can easily convert <b>DOCX to JPG</b>, <b>DOCX to PNG</b> or any other image format.</p>
<p>Conversion supports both raster (JPG, GIF, PNG, etc.) and vector image formats (SVG, EMF, etc.).</p>
<h2>Convert Word to HTML in C#</h2>
<p>.NET SDK provides an easy way to instantly convert Word document into perfect Web documents. Easily convert <b>DOCX to HTML</b>, Markdown, MHTML and other popular Web formats.</p>
<h2>Getting Started with C# library</h2>
<ul>
...
<li>Check out our <a target="_blank" href="https://github.com/aspose-words-cloud/aspose-words-cloud-dotnet">GitHub repository</a> for a complete API list
...
<h1>How to Convert a DOCX in C#</h1>
<ol>
...
var request = new SaveAsRequest("sample.docx", saveOptions);
wordsApi.SaveAs(request);

// Convert DOCX to HTML with advanced options
var htmlFixedOptions = new HtmlFixedSaveOptionsData()
{
...
var request = new SaveAsRequest("source.docx", htmlFixedOptions);
wordsApi.SaveAs(request);</code></pre>
</div>
<br /><br /></div>
</div>
</div>
...
{{< blocks/products/pf/slr-element name="Source Code" href="https://github.com/aspose-words-cloud/aspose-words-cloud-donet" >}}
