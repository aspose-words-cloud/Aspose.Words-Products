---
title: Word Document Tables API for Java 
description: Tables in Word Documents in Java with Cloud API. Add a table, add a row, extract data from a table
weight: 60
url: /java/tables
---
...
<div class="container">
<div class="row">
<h1>Tables in Word Documents with Java</h1>
</div>
</div>
</div>
<div class="wmh">
...
<div class="container">
<div class="row">
<p class="navbar-text"><a href="/words/family/">Words Cloud</a> / <a id="sdk" href="/words/java/"> Java</a> / Tables</p>
</div>
</div>
</div>
<div class="wgray">
<div class="container">
<div class="row">
<div class="w"><p>Add or delete a table, add a row or a column,  extract data from a table, - all this and much more you can do with Word documents in Java with Cloud API.</p>
<p>If you have worked in Microsoft Word, then you understand the main concept of working with tables to create text and graphics or showing data in a tabular
	...
	in one cell and align it accordingly. Furthermore, tables can be nested inside other tables up to any depth with Java API.</p>
...
<p>A table is made up of rows and columns. The intersection of a row and column is called a cell.<br/>
	You can use Cloud API in Java to create a table, format it, apply a style, modify a table in code, insert data into rows and cells.<br/>
...
<h3>Table manipulation in Java</h3>
<p>You can perform the following tasks with tables in DOCX, DOC, RTF and document file formats using Java:</p>
<ul>
...
<h3>Extract data from tables using Java</h3>
<p>Java API allows you to extract text from tables. You can call API methods to get a row or to get a cell from a table.</p>
<h3>Working with borders and margins</h3>
<p>You can set border style, margins and cell padding in tables with Java API. You can use border property to set a border for a table. You can apply borders
...
<h2>Table properties with Java API</h2>
...
<h3>Alignment</h3>
<p>You can align a table between page margins either right, left, or center with Java API.</p>
<h3>Merge a table</h3>
<p>Java API allows you to merge two or more tables into one larger table. After merging tables, you can also merge specific cells within the table.</p>
<h3>Split a table</h3>
<p>It allows you to split a table into two or more tables. It creates smaller tables or adds text between two tables.</p>
<h1>How to work with tables in a DOCX document in Java</h1>
<ol>
...
<li>Add <a href="https://github.com/aspose-words-cloud/aspose-words-cloud-java#installation--usage" target="_blank" rel="noopener">Java dependency</a>.</li>	<li>Check <a href="https://docs.aspose.cloud/display/wordscloud/Working+with+Tables" target="_blank">Developer Guide</a> to work with tables in a DOCX file in Java.</li>
</ol>
<br/>
<br /><br /></div>
</div>
