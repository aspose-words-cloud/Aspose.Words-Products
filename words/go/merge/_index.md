---
title: Merge DOCX, RTF, TXT Documents | Go (Golang) 
description: Merge Word Documents in Go (Golang) with Cloud API. Combine DOCX, HTML, TXT and other formats into one (PDF, DOCX)
weight: 40
url: /go/merge
---
...
<div class="container">
<div class="row">
<h1>Merge Word Documents in Go (Golang)</h1>
</div>
</div>
</div>
<div class="wmh">
...
<div class="container">
<div class="row">
<p class="navbar-text"><a href="/words/family/">Words Cloud</a> / <a id="sdk" href="/words/go/"> Go</a> / Merge</p>
</div>
</div>
</div>
<div class="wgray">
<div class="container">
<div class="row">
<div class="w"><p>Merge Word documents with Aspose Cloud Go library. Merge multiple files in DOCX, DOC and other formats into a
...
<h2>Automate document merging with Go</h2>
<p>Words Cloud Go SDK provides a simple to use and secure API to merge Word documents with fast speed and high
...
<p>Instead of spending minutes combining files yourself, you should be able to put them together within seconds by
	using just a one-line method call from our Go SDK.</p>
...
<p><strong>Tip</strong>: <a href="/words/go/split" target="_blank">Splitting</a> a Word document is
	also possible.<br/>
</p>
...
<p>We provide the best document-processing capabilities and features with our constantly evolving <a
	...
	specific needs.</p>
<p>With our Go library you can:</p>
<ul>
...
<h1>How to Merge a DOCX in Go</h1>
<ol>
...
<li>Check out the <a href="https://docs.aspose.cloud/display/wordscloud/Appending+a+Document" target="_blank">Developer
		Guide</a> to merge a DOCX in Go.
	</li>
<li>Check out our <a href="https://github.com/aspose-words-cloud/aspose-words-cloud-go" target="_blank">GitHub repository</a> for a complete API list along
...
<div class="codeheader">Merge a Word document in Go</div>
...
wordsApi.AppendDocument(ctx, "source.docx", docList, options)</code></pre>
</div>
