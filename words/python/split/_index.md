---
title: Split API for Python 
description: Split Word Documents in Python with Cloud API. Split a document into PDF, JPEG, DOCX, etc.
weight: 40
url: /python/split
---
...
<div class="container">
<div class="row">
<h1>Split Word Documents in Python</h1>
</div>
</div>
</div>
<div class="wmh">
...
<div class="container">
<div class="row">
<p class="navbar-text"><a href="/words/family/">Words Cloud</a> / <a id="sdk" href="/words/python/"> Python</a> / Split</p>
</div>
</div>
</div>
<div class="wgray">
<div class="container">
<div class="row">
<div class="w"><p>Words Cloud Python SDK provides an easy to use API to split DOCX, RTF, ODT and other file formats.<br/>
...
<h2>Overview</h2>
<p>Use Python to split a Word document into multiple smaller files, or to extract pages to a new file.</p>
<p><strong>Tip</strong>: <a href="/words/python/merge" target="_blank">Merging</a> different Word documents is also possible.<br/>
...
<h3>Why split a Word document using Python?</h3>
...
<h3>What does split API for Python do?</h3>
<ul>
...
<p>Luckily for you, Words Cloud API has the answer.<br/>
	...
	Using an API client is the quickest way for a Python developer to speed up the development. API takes care of
...
<li>Check out our <a href="https://github.com/aspose-words-cloud/aspose-words-cloud-python" target="_blank">GitHub repository</a> for a complete API list along with
		working examples.
	</li>
<li>Try our <a href="http://products.aspose.app/words/splitter" target="_blank">free online Splitter</a>.</li>
</ul>
<h2>How to Split a DOCX document in Python</h2>
<ol>
...
<li>Check <a href="https://docs.aspose.cloud/display/wordscloud/Splitting+a+Document" target="_blank">Developer
		Guide</a> to split a DOCX file in Python.
	</li>
...
<div class="codeheader">Split a Word document in Python</div>
<pre data-nosnippet><code class="python hljs" >import asposewordscloud
from asposewordscloud.models.requests import SplitDocumentRequest
...
request = SplitDocumentRequest('sample.docx', format='pdf')
words_api.split_document(request)

# Split page range 2-5 and save to JPEG
request = SplitDocumentRequest('sample.docx', format='jpeg', _from=2, to=5)
words_api.split_document(request)

# Split all pages, save to HTML and zip output files
request = SplitDocumentRequest('sample.docx', format='html', zip_output=True)
words_api.split_document(request)
</code></pre>
</div>
<br /><br /></div>
